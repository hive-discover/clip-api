...
with open('data/normalize.pickle', 'rb') as handle:
...
model = svmutil.svm_load_model('data/brisque_svm.txt')
...
def score_image(image : np.ndarray, kernel_size : int = 7, sigma : float = 7/6) -> float:
    gray_image = skimage.color.rgb2gray(image)

    brisque_features = calculate_brisque_features(gray_image, kernel_size=kernel_size, sigma=sigma)
...
if __name__ == '__main__':
    image = skimage.io.imread("data/dog.jpg")
